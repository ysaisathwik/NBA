...
class ExecutionAgent(Agent):
    ...
    def _run(self, session) -> dict[str, Any]:
        ...
        # Email notifications are dispatched by the orchestrator at the correct gate points
        # (engineer-assigned after execution, task-assigned at Gate 2, work-done after Gate 2).
